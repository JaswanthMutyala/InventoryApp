...
async function GET(request) {
    try {
        ...
        if (!authHeader?.startsWith('Bearer ')) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Unauthorized'
        }, {
            status: 401
        });
        ...
        const [requestingUserRows] = await db.query('SELECT role FROM users WHERE id = ?', [
            userId
        ]);
        const requestingUser = requestingUserRows[0];
        if (!requestingUser || requestingUser.role !== 'admin') return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Forbidden'
        }, {
            status: 403
        });
...
async function DELETE(request) {
    try {
        ...
        if (password !== ADMIN_PASSWORD) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        await db.query('DELETE FROM access_logs WHERE user_id = ?', [
            userId
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1a894d79._.js.map