...
async function GET() {
    try {
        const transactions = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare(`
...
async function POST(request) {
    try {
        ...
        if (!product_id || !user_id || !type || !quantity) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        // Start a transaction
        const transaction = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].transaction(()=>{
            // Check product availability
            const product = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare('SELECT quantity FROM products WHERE id = ?').get(product_id);
            if (!product) {
            ...
            if (type === 'CHECKOUT') {
                ...
                // Check how much the user has checked out for this product
                const userCheckout = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare(`
                ...
                const userCheckin = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare(`
                    SELECT SUM(quantity) as total_checked_in FROM transactions 
                    WHERE user_id = ? AND product_id = ? AND type = 'CHECKIN'
                `).get(user_id, product_id);
                const totalCheckedOut = userCheckout?.total_checked_out || 0;
                const totalCheckedIn = userCheckin?.total_checked_in || 0;
                const outstandingQuantity = totalCheckedOut - totalCheckedIn;
                if (quantity > outstandingQuantity) {
                    throw new Error(`You have only ${outstandingQuantity} unit(s) to return for this product, but tried to return ${quantity}`);
                }
                newQuantity += quantity;
            } else {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare('UPDATE products SET quantity = ? WHERE id = ?').run(newQuantity, product_id);
            // Record transaction
            const result = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare('INSERT INTO transactions (product_id, user_id, type, quantity) VALUES (?, ?, ?, ?)').run(product_id, user_id, type, quantity);
            return {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cb631330._.js.map