...
async function GET() {
    try {
        const products = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare('SELECT * FROM products ORDER BY created_at DESC').all();
...
async function POST(request) {
    try {
        ...
        if (!name || !user_id || !file || typeof file === 'string') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Name, image file, and user_id are required'
            }, {
                status: 400
            });
        }
        ...
        const result = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare('INSERT INTO products (name, description, quantity, image_url) VALUES (?, ?, ?, ?)').run(name, description, quantity || 0, image_url);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cd3d52d3._.js.map